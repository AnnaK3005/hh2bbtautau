...
epochs=100
model_name = f"gen_model_5_layers_10_nodes_{epochs}_epochs_with_z_pos_and_pt"
...
output_path = os.path.join(
    thisdir,
    'dnn_models', 'plots', 'gen_model_with_z_pos_and_pt', 'ROC_plots',
    model_name
)
draw_roc(
    y_test = y_test,
...
def plot_loss():
    ...
    plt.savefig('/afs/desy.de/user/k/kindsvat/Documents/hh2bbtautau/hbt/ml/dnn_models/plots/gen_model_with_z_pos_and_pt/loss_and_accuracy/gen_model_'+ model_name +"_loss_and_val_loss")
...
def plot_accuracy():
    ...
    plt.legend(loc='upper left')
    plt.savefig('/afs/desy.de/user/k/kindsvat/Documents/hh2bbtautau/hbt/ml/dnn_models/plots/gen_model_with_z_pos_and_pt/loss_and_accuracy/gen_model_'+ model_name +"_binary_accuracy_and_val_binary_accuracy")
...
for label, data, truth_labels in zip(
    ...
    for mask_value in np.unique(truth_labels):
        ...
        output_folder = os.path.join(thisdir, 'dnn_models', 'output_gen_model_with_z_pos_and_pt')
